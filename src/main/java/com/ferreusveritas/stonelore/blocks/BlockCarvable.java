...
public class BlockCarvable extends Block implements ICarvable {
	...
	public static void addBlocks(String[] names, BlockCarvable block, String name){
		for(int i = 0; i < names.length; i++){
			block.carverHelper.addVariation("tile." + StoneLore.MODID + "_" + name + "." + names[i] + ".name", i, names[i], StoneLore.MODID);
		}
	...
	public void registerBlockIcons(IIconRegister register) {
		carverHelper.registerBlockIcons(StoneLore.MODID, this, register);
	}
	...
	public static class SoundType extends Block.SoundType {
		...
		public String getBreakSound() {
			if (soundNameBreak == null)
				return StoneLore.MODID + ":dig." + this.soundName;
			else
		...
		public String getStepResourcePath() {
			if (soundNameStep == null)
				return StoneLore.MODID + ":step." + this.soundName;
			else
