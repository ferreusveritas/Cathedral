...
public class RendererItemDoor implements IItemRenderer {
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
		...
		for(int i = 0; i < doorHeight; i++){
			...
			Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation(Cathedral.MODID, "textures/blocks/" + asset + "_" + i + ".png"));
		...
		Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation(Cathedral.MODID, "textures/blocks/" + asset + "_side.png"));
		...
		Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation(Cathedral.MODID, "textures/blocks/" + asset + "_top.png"));
