...
import com.ferreusveritas.stonelore.gargoyle.BlockGargoyle;
import com.ferreusveritas.stonelore.gargoyle.EntityGargoyle;
import com.ferreusveritas.stonelore.model.QuadWavefrontObject;
...
public class RendererGargoyle implements ISimpleBlockRenderingHandler {
	...
	public RendererGargoyle() {
		...
		gargoyleModel = new QuadWavefrontObject(new ResourceLocation(StoneLore.MODID, "models/gargoyle.obj"));
	}
